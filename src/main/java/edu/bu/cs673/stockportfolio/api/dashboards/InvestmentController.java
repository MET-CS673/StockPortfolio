...
public class InvestmentController {
     ...
     * Responsible for handling request to show stock breakdowns.
     * 
    ...
    /**
     * GET Mapping for 'stock_breakdown', shows the "stock_breakdown" view.
     * 
     ...
     * to the model attribute data for rendering in the view '/stock_breakdown.html'.
     * 
