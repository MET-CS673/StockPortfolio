...
public class MarketCapController {
     ...
     * the user's accounts and then for each Market Cap Type, aggregate the account data and
     * add as a model attribute with the market cap type as the key, for rendering in the view
     * '/mc_breakdown.html'.</p>
     * 
     ...
     * @throws PortfolioNotFoundException if portfolio not found.
     */
    @GetMapping
